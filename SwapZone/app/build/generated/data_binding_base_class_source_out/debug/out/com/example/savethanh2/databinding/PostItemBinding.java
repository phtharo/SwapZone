...
public final class PostItemBinding implements ViewBinding {
  ...
  private PostItemBinding(@NonNull LinearLayout rootView, @NonNull Button btnPostLeft,
  ...
  public static PostItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PostItemBinding((LinearLayout) rootView, btnPostLeft, imageView, textView,
          textView2);
    }
